class Hub < ActiveRecord::Base
  ...
  validates :latitude, numericality: { only_integer: true, :greater_than_or_equal_to => -90, :less_than_or_equal_to => 90}
  validates :longitude, numericality: { only_integer: true, :greater_than_or_equal_to => -180, :less_than_or_equal_to => 180}
  validates :status_code, uniqueness: true, numericality: { only_integer: true}
